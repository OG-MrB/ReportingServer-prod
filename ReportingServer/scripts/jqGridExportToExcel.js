function ExportJQGridDataToExcel(tableCtrl, title, type, criteriaArray, excelFilename) {
    ...
    if (type == "word") {
        postAndRedirect("Handlers/ExportGridToWord.ashx?filename=" + title + "&criteria=" + criteriaArray, { excelData: excelData });
        
    }
    if (type == "pdf") {
        postAndRedirect("Handlers/ExportGridToPDF.ashx?filename=" + title + "&criteria=" + criteriaArray, { excelData: excelData });
    }
    if (type == "excel") {
        postAndRedirect("Handlers/ExportGridToExcel.ashx?filename=" + title + "&criteria=" + criteriaArray, { excelData: excelData });
    }
